...
prompt  ...plugins
--
--application/shared_components/plugins/dynamic_action/com_jafr_apexnoti
 
begin
 
wwv_flow_api.create_plugin (
  p_id => 278232105434360841 + wwv_flow_api.g_id_offset
 ...
 ,p_plsql_code => 
'function render_apexNoti ('||unistr('\000a')||
...
'  '||unistr('\000a')||
'  l_error varchar2(50) := p_dynamic_action.attribute_01; -- Error as Alert or Console Message'||unistr('\000a')||
'  l_title varchar2(100) := apex_escape.html(p_dynamic_action.attribu'||
'te_02); -- Title of Notification'||unistr('\000a')||
'  l_icon varchar2(200) := apex_escape.html(p_dynamic_action.attribute_03); -- Icon on Notification'||unistr('\000a')||
'  l_body varchar2(500) := apex_escape.html(p_dynamic_action.attribute_04); -- Notification Body'||unistr('\000a')||
'  l_redirectLink varchar2(200) := apex_escape.html(p_dynamic_action.attribute_05); -- Link to Open'||unistr('\000a')||
'  l_timeOut varchar2(50) := apex_escape.html(p_dynamic_action.attribute_0'||
'6); -- Timeout Seconds'||unistr('\000a')||
'  l_code varchar2(5000);'||unistr('\000a')||
'  '||unistr('\000a')||
'  v_redirectLink varchar2(500); -- Temporary Variable for Redirect Code'||unistr('\000a')||
'  v_timeOut varchar2(200); -- Temporary Variable for Timeout Code'||unistr('\000a')||
'  '||unistr('\000a')||
'begin'||unistr('\000a')||
'  l_code := ''function notifyMe() {'||unistr('\000a')||
'  if (!("Notification" in window)) {'||unistr('\000a')||
'    %ERROR%("This browser does not support system notifications");'||unistr('\000a')||
'  }'||unistr('\000a')||
'  else if (Notification.permission === "granted") {'||unistr('\000a')||
'    not'||
'ify();'||unistr('\000a')||
'  }'||unistr('\000a')||
'  else if (Notification.permission !== "denied") {'||unistr('\000a')||
'    Notification.requestPermission(function (permission) {'||unistr('\000a')||
'      if (permission === "granted") {'||unistr('\000a')||
'        notify();'||unistr('\000a')||
'      }'||unistr('\000a')||
'    });'||unistr('\000a')||
'  }'||unistr('\000a')||
'  '||unistr('\000a')||
'  function notify() {'||unistr('\000a')||
'    var notification = new Notification("%TITLE%", {'||unistr('\000a')||
'      icon: "%ICON%",'||unistr('\000a')||
'      body: "%BODY%",'||unistr('\000a')||
'    });'||unistr('\000a')||
''||unistr('\000a')||
'    %REDIRECT%'||unistr('\000a')||
'	'||unistr('\000a')||
'    %TIMEOUT%'||unistr('\000a')||
'  }'||unistr('\000a')||
''||unistr('\000a')||
'  }'';'||unistr('\000a')||
'  -- Print Error as an Alert o'||
'r in the Console'||unistr('\000a')||
'  if l_error = ''ALERT'' then'||unistr('\000a')||
'    l_code := replace(l_code, ''%ERROR%'', ''alert'');'||unistr('\000a')||
'  elsif l_error = ''CONSOLE'' then'||unistr('\000a')||
'    l_code := replace(l_code, ''%ERROR%'', ''console.log'');'||unistr('\000a')||
'  end if;'||unistr('\000a')||
'  '||unistr('\000a')||
'  -- Set TITLE'||unistr('\000a')||
'  l_code := replace(l_code, ''%TITLE%'', l_title);'||unistr('\000a')||
'  '||unistr('\000a')||
'  -- Set ICON'||unistr('\000a')||
'  if l_icon is not null then'||unistr('\000a')||
'    l_code := replace(l_code, ''%ICON%'', l_icon);'||unistr('\000a')||
'  else'||unistr('\000a')||
'    l_icon := p_plugin.file_prefix '||
'|| ''notification-icon.png'';'||unistr('\000a')||
'    l_code := replace(l_code, ''%ICON%'', l_icon);'||unistr('\000a')||
'  end if;'||unistr('\000a')||
'  -- Set Body Message'||unistr('\000a')||
'  l_code := replace(l_code, ''%BODY%'', l_body);'||unistr('\000a')||
'  '||unistr('\000a')||
'  -- Set Redirect Link if Existant'||unistr('\000a')||
'  if l_redirectLink is not null then'||unistr('\000a')||
'    v_redirectLink := ''notification.onclick = function () {'||unistr('\000a')||
'      window.open("%LINK%");      '||unistr('\000a')||
'    };'';'||unistr('\000a')||
'    v_redirectLink := replace(v_redirectLink, ''%LINK%'', l_redirec'||
'tLink);'||unistr('\000a')||
'	l_code := replace(l_code, ''%REDIRECT%'', v_redirectLink);'||unistr('\000a')||
'  else'||unistr('\000a')||
'    l_code := replace(l_code, ''%REDIRECT%'', '' '');'||unistr('\000a')||
'  end if;'||unistr('\000a')||
'  '||unistr('\000a')||
'  -- Set Timeout if Existant'||unistr('\000a')||
'  if l_timeOut is not null then'||unistr('\000a')||
'    v_timeOut := ''setTimeout(notification.close.bind(notification), %TIME%);'';'||unistr('\000a')||
'    v_timeOut := replace(v_timeOut, ''%TIME%'', l_timeOut);'||unistr('\000a')||
'	l_code := replace(l_code, ''%TIMEOUT%'', v_timeOut);'||unistr('\000a')||
'  else'||unistr('\000a')||
'    l_c'||
'ode := replace(l_code, ''%TIMEOUT%'', '' '');'||unistr('\000a')||
'  end if;'||unistr('\000a')||
'  '||unistr('\000a')||
'  v_result.javascript_function := l_code;'||unistr('\000a')||
'  '||unistr('\000a')||
'return v_result;'||unistr('\000a')||
'end render_apexNoti;'||unistr('\000a')||
'  '
...
'	This plugin uses the Notification API to show custom notifications. Your browser must support the notification API.</div>'||unistr('\000a')||
'<div>'||unistr('\000a')||
'	&nbsp;</div>'||unistr('\000a')||
'<div>'||unistr('\000a')||
'	Must browsers these days do. If your browser doesn&#39;t you can choose to receive an error message either as an alert or in the console.</div>'||unistr('\000a')||
'<div>'||unistr('\000a')||
'	&nbsp;</div>'||unistr('\000a')||
'<div>'||unistr('\000a')||
'	For more information regarding the notifications interface refer to : https://developer.mozilla.org/en-US/docs/Web/API/notification</div>'||unistr('\000a')||
''
 ,p_version_identifier => '1.0'
 ,p_about_url => 'http://farzadsoltani.com/2017/03/05/notifications-apexnoti-oracle-apex/'
  );
wwv_flow_api.create_plugin_attribute (
  p_id => 278234530223364525 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 278232105434360841 + wwv_flow_api.g_id_offset
 ...
 ,p_help_text => 'This option has two available types. If "Alert" is chosen and the plugin can''t run due to lack of support regarding the Notification API in your browser, you will receive a javascript alert that says your browser is unsupported. If "Console" is chosen, this message is printed in the console.log.'
  );
wwv_flow_api.create_plugin_attr_value (
  p_id => 278234927851365634 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 278234530223364525 + wwv_flow_api.g_id_offset
 ,p_display_sequence => 10
 ,p_display_value => 'Alert'
 ,p_return_value => 'ALERT'
  );
wwv_flow_api.create_plugin_attr_value (
  p_id => 278235326557366195 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 278234530223364525 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_attribute (
  p_id => 278238000893378106 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 278232105434360841 + wwv_flow_api.g_id_offset
 ,p_attribute_scope => 'COMPONENT'
...
wwv_flow_api.create_plugin_attribute (
  p_id => 278238630858379461 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 278232105434360841 + wwv_flow_api.g_id_offset
 ,p_attribute_scope => 'COMPONENT'
 ...
 ,p_is_required => false
 ,p_is_translatable => false
 ,p_help_text => 'Sets the icon for the notification. Without an icon it isn''t appealing. A default icon file has been added.'||unistr('\000a')||
''||unistr('\000a')||
'The suitable size for your image file is 100x100 pixels with a white background (For chrome).'||unistr('\000a')||
''||unistr('\000a')||
'You can also refer to files uploaded in Shared Components => Static Application Files.'
  );
wwv_flow_api.create_plugin_attribute (
  p_id => 278239518349385187 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 278232105434360841 + wwv_flow_api.g_id_offset
 ,p_attribute_scope => 'COMPONENT'
...
wwv_flow_api.create_plugin_attribute (
  p_id => 278239914252387108 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 278232105434360841 + wwv_flow_api.g_id_offset
 ,p_attribute_scope => 'COMPONENT'
 ...
 ,p_is_required => false
 ,p_is_translatable => false
 ,p_help_text => 'Set the link for the notification. This link is opened in a new tab when you click on the notification itself. '||unistr('\000a')||
''||unistr('\000a')||
'Just to be safe include "http://....." at the beginning of your link.'
  );
wwv_flow_api.create_plugin_attribute (
  p_id => 278240411017388670 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 278232105434360841 + wwv_flow_api.g_id_offset
 ,p_attribute_scope => 'COMPONENT'
 ...
 ,p_is_required => false
 ,p_is_translatable => false
 ,p_help_text => 'Set this optional attribute for the timeout of the notification.'||unistr('\000a')||
''||unistr('\000a')||
...
wwv_flow_api.create_plugin_file (
  p_id => 278241709316394513 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 278232105434360841 + wwv_flow_api.g_id_offset
