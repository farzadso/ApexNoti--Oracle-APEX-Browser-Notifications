...
'  l_title varchar2(100) := p_dynamic_action.attribute_02; -- Title of Notification',
'  l_icon varchar2(200) := p_dynamic_action.attribute_03; -- Icon on Notification',
'  l_body varchar2(500) := p_dynamic_action.attribute_04; -- Notification Body',
'  l_redirectLink varchar2(200) := p_dynamic_action.attribute_05; -- Link to Open',
'  l_timeOut varchar2(50) := p_dynamic_action.attribute_06; -- Timeout Seconds',
